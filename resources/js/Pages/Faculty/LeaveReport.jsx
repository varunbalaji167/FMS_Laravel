...
export default function LeaveReport({ leaves = { data: [], links: [] }, summary = {}, filters = {} }) {
    ...
    const handleFilter = () => {
        router.get(route('faculty.leaves.report'), {
            ...
            <div className="py-12">
                <div className="max-w-6xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div className="bg-white shadow-sm sm:rounded-lg p-6">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">My Leave Report</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-white shadow-sm sm:rounded-lg p-6">
                            ...
                            <div className="space-y-3">
                                ...
                                {Object.values(summary.by_leave_type).every(d => d.count === 0) && (
                        ...
                        <div className="bg-white shadow-sm sm:rounded-lg p-6">
                            ...
                            <div className="space-y-3">
                                <div className="flex justify-between items-center p-3 bg-green-50 rounded">
                                    ...
                                    <p className="text-lg font-bold text-green-600">{summary.by_status.approved.count} ({summary.by_status.approved.days} days)</p>
                                </div>
                                ...
                                <div className="flex justify-between items-center p-3 bg-orange-50 rounded">
                                    <p className="font-semibold text-gray-900">Pending Recommendation</p>
