...
const LeaveApprovalCard = ({ leave, leaveTypes }) => {
        ...
        <Card className="hover:shadow-md transition-shadow border-l-4 border-l-blue-600">
            <CardContent className="pt-6">
                <div className="space-y-4">
                    ...
                    <div className="flex items-start justify-between gap-4">
                        <div className="flex-1">
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="px-3 py-1 rounded-full text-xs font-medium flex items-center gap-1 bg-orange-50 text-orange-600">
                    ...
                    {/* Leave Type & Recommender Info */}
                    <div className="grid grid-cols-2 gap-4 bg-blue-50 rounded-lg p-3 border border-blue-200">
                        <div>
...
export default function PendingApprovals({ leaves, leaveTypes, auth }) {
    ...
    return (
        <AdminLayout>
            <Head title="Leave Approvals | FMS" />
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-slate-600 text-sm">
                            Review and finalize leave requests that have been recommended
                            by HODs
                        </p>
                    </div>
                </div>
