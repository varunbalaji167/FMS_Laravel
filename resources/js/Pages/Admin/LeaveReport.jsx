...
export default function LeaveReport({ leaves = { data: [], links: [] }, summary = {}, departmentSummary = {}, filters = {} }) {
    ...
    const handleFilter = () => {
        router.get(route('admin.leaves.report'), {
            search: searchTerm,
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                                ...
                                <table className="w-full">
                                    <thead className="bg-gray-50">
                                        <tr>
                                            ...
                                            <th className="px-6 py-3 text-left text-sm font-semibold text-gray-900">Faculty Count</th>
                                    ...
                                    <tbody className="divide-y divide-gray-200">
                                        {Object.entries(departmentSummary).map(([dept, data]) => (
                                            <tr key={dept} className="hover:bg-gray-50">
                                                <td className="px-6 py-4 font-semibold text-gray-900">{dept}</td>
                                                <td className="px-6 py-4 text-gray-700">{data.faculty_count}</td>
                                                <td className="px-6 py-4 text-gray-700">{data.total_requests}</td>
                                                ...
                                                <td className="px-6 py-4 font-semibold text-gray-900">{data.total_days}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
                    ...
                    <div className="bg-white shadow-sm sm:rounded-lg">
                        <div className="p-6">
                            <h2 className="text-xl font-bold text-gray-900 mb-4">All Leave Requests</h2>
